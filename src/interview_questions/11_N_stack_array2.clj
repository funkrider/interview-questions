(ns interview-questions.11-N-stack-array2
...
(defrecord ArrayStack [stacks array-size]
  ...
  (start [component]
    ...
    (let [stack-count stacks
          data-length array-size
          data (atom (apply vector-of :char (repeat data-length \space)))
          available-index (atom (apply list (range 0 data-length)))
...
;; Constructor method
(defn new-arraystack [stacks array-size]
